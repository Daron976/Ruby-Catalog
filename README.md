...
In this project, we create a console app that helps to keep a record of different items of ownership: books, music albums, movies, and games.
...
- **Keeps a record of different types of items**
- **Stores items**
...
- Twitter: [@twitterhandle](https://twitter.com/KarayamanEmre)
...
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/ashwin-success/)
...
Feel free to check the [issues page](https://github.com/Daron976/Ruby-Catalog/issues). 
